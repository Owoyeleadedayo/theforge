  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.success("Application Received ✅", {
        description:
          "Thank you for volunteering! We're excited for what's ahead. We'll reach out to you soon.",
        duration: 5000,
      });
      ...
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-10 space-y-3">
          ...
          <p className="text-muted-foreground">
            The church will be built with a volunteer core: high-heart,
            high-integrity people who want to serve meaningfully and build
            excellently. If you'd like to be considered, apply here.
          </p>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Why do you want to volunteer with the church?
                  </FormLabel>
                  <FormControl>
                    <Textarea
